...
# Les fonctions sont ci-dessous commentées pour ne pas perturber l'execution du Markdown.
# Si vous souhaitez executé les fonctions plus en détails, vous pouvez les décommenter.
